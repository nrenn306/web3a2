    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-12">
      <div className="flex min-h-[28rem] flex-col overflow-hidden rounded-lg border border-gray-200 bg-white lg:flex-row">
        ...
        <section className="min-w-0 flex-1 bg-gray-50 p-6">
          <SongsBrowseHeader loadNotice={loadNotice} sortBy={sortBy} onSortChange={setSortBy}/>

          <SongFilterChips chips={chips} hasActiveFilters={hasActiveFilters} onClearAll={clearAllFilters}/>
